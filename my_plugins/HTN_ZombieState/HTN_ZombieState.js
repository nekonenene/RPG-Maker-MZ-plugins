 ...
 *
 * 【制限事項】
 * setHp() や setMp() が直接呼び出されてHP・MPが増加する場合、
 * 反転は正しく機能しますが、ダメージポップアップの表示やSE再生はされません。
 * setTp() が直接呼び出されてTPが増加する場合、
 * 反転は正しく機能しますが、バトルログには表示されません。
